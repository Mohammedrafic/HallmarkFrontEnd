...
import { ytdReportConstants, analyticsConstants,  Month, Year } from '../constants/analytics.constant';
...
@Component({
  selector: 'app-ytd-report',
  templateUrl: './ytd-report.component.html',
  styleUrls: ['./ytd-report.component.scss']
})
export class YtdReportComponent implements OnInit, OnDestroy {
  public title: string = "YTD Report";
  ...
  public reportName: LogiReportFileDetails = { name: "/JsonApiReports/YTDSummaryReportByMonth/YTDSummaryReportByMonth.cls" };
  public catelogName: LogiReportFileDetails = { name: "/JsonApiReports/YTDSummaryReportByMonth/YTDSummaryReportByMonth.cat" };
  ...
  public ytdreportReportForm: FormGroup;
  ...
  //public YTDReportSearchByItems = YTDReportSearchBy;
  ...
  ngOnInit(): void {
    ...
    this.organizationId$.pipe(takeUntil(this.unsubscribe$)).subscribe((data: number) => {
      ...
      this.user?.businessUnitType == BusinessUnitType.Hallmark ? this.ytdreportReportForm.get(ytdReportConstants.formControlNames.BusinessIds)?.enable() : this.ytdreportReportForm.get(analyticsConstants.formControlNames.BusinessIds)?.disable();
    });
  }
  ...
  public onFilterControlValueChangedHandler(): void {
    this.bussinessControl = this.ytdreportReportForm.get(ytdReportConstants.formControlNames.BusinessIds) as AbstractControl;
    ...
    this.organizationData$.pipe(takeUntil(this.unsubscribe$)).subscribe((data) => {
      if (data != null && data.length > 0) {
        ...
        this.ytdreportReportForm.get(ytdReportConstants.formControlNames.BusinessIds)?.setValue(this.agencyOrganizationId);
  ...
  //  this.skillCategoryIdControl = this.ytdreportReportForm.get(analyticsConstants.formControlNames.SkillCategoryIds) as AbstractControl;
  ...
  //    }
  //    else {
  //      this.ytdreportReportForm.get(analyticsConstants.formControlNames.SkillIds)?.setValue([]);
  //    }
  //  });
  //  this.skillIdControl = this.ytdreportReportForm.get(analyticsConstants.formControlNames.SkillIds) as AbstractControl;
  ...
  public onFilterDelete(event: FilteredItem): void {
    this.filterService.removeValue(event, this.ytdreportReportForm, this.filterColumns);
  }
  ...
  public onFilterApply(): void {
   ...
   /* if (!(regionIds.length > 0 && locationIds.length > 0 && departmentIds.length > 0)) {*/
    ...
    if(this.ytdreportReportForm.valid)
    {
      this.filteredItems = [];
      this.SearchReport();
