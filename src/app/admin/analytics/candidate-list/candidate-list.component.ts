...
export class CandidateListComponent implements OnInit {
  ...
  public onFilterClearAll(): void {
    ...
    this.candidateRegularRateForm.get(analyticsConstants.formControlNames.StartDate)?.setValue(null);
    this.candidateRegularRateForm.get(analyticsConstants.formControlNames.EndDate)?.setValue(null);
    this.filteredItems = [];
  }
