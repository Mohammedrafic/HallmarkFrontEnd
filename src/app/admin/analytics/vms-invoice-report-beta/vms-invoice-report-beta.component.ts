...
@Component({
  selector: 'app-vms-invoice-report-beta',
  templateUrl: './vms-invoice-report-beta.component.html',
  styleUrls: ['./vms-invoice-report-beta.component.scss']
})
export class VmsInvoiceReportBetaComponent implements OnInit, OnDestroy {
