...
import { CommonReportFilter } from '../models/common-report.model';
...
export class UnitProfileComponent implements OnInit {
  ...
  public unitProfileReportForm: FormGroup;
  RegularReportName: string = '/IRPReports/UnitProfile/UnitProfileReport.cls'
  ...
  public title: string = 'Unit Profile';
  ...
  ngOnInit(): void {
    this.organizationId$.pipe(takeUntil(this.unsubscribe$)).subscribe((data: number) => {
      ...
      this.user?.businessUnitType == BusinessUnitType.Hallmark
        ? this.unitProfileReportForm.get(analyticsConstants.formControlNames.BusinessIds)?.enable()
        : this.unitProfileReportForm.get(analyticsConstants.formControlNames.BusinessIds)?.disable();
    });
  }
  ...
  public onFilterControlValueChangedHandler(): void {
    this.bussinessControl = this.unitProfileReportForm.get(
  ...
  public onFilterRegionChangedHandler(): void {
    this.regionIdControl = this.unitProfileReportForm.get(
      analyticsConstants.formControlNames.RegionIds
    ) as AbstractControl;
    this.regionIdControl.valueChanges.pipe(takeUntil(this.unsubscribe$)).subscribe((data) => {
      this.departments = [];
      this.locations = [];
      this.unitProfileReportForm.get(analyticsConstants.formControlNames.LocationIds)?.setValue([]);
      this.unitProfileReportForm.get(analyticsConstants.formControlNames.DepartmentIds)?.setValue([]);
  ...
  public onFilterLocationChangedHandler(): void {
    this.locationIdControl = this.unitProfileReportForm.get(
  ...
  public onFilterDelete(event: FilteredItem): void {
    this.filterService.removeValue(event, this.unitProfileReportForm, this.filterColumns);
  }
  ...
  public onFilterApply(): void {
    this.unitProfileReportForm.markAllAsTouched();
    if (this.unitProfileReportForm?.invalid) {
      return;
    }
    this.filteredItems = [];
    this.SearchReport();
  ...
  public SearchReport(): void {    
    ...
    let {
      ...
      locationIds,
      regionIds
    } = this.unitProfileReportForm.getRawValue();
    if (!this.unitProfileReportForm.dirty) {
