...
export const widgetTypeToConfigurationMapper: Record<WidgetTypeEnum, PanelModel> = {
  ...
  [WidgetTypeEnum.RN_UTILIZATION]: { sizeX: 3, sizeY: 3, maxSizeX: 3, maxSizeY: 3, minSizeX: 3, minSizeY: 3 },
  ...
  [WidgetTypeEnum.ACTIVE_POSITIONS_INITIAL_EXTENDED]: { sizeX: 5, sizeY: 5, maxSizeX: 5, maxSizeY: 5,  minSizeX: 5, minSizeY: 5},
};
