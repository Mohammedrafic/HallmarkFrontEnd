...
} from '@client/order-management/order-details-form/constants/order-details.constant';
...
export class OrderDetailsFormComponent extends Destroyable implements OnInit {
  ...
  private getOrderRequisition(): void {
