...
const employeeImportConfig = {
  ...
  saveImportResultFailAndSucess : { instance: SaveEmployeeImportResultFailAndSucceeded, message: '<sn> records successfully processed. <fn> records failed to process.' }
};
