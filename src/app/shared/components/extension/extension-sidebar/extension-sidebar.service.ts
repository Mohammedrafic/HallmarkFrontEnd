...
export class ExtensionSidebarService {
  ...
  private prepareExtension(extension: ExtensionFormData): ExtensionModel {
    ...
    return {
      ...
      billRates,
      comments,
      actualStartDate: DateTimeHelper.setInitHours(DateTimeHelper.setUtcTimeZone(startDate)),
      actualEndDate: DateTimeHelper.setInitHours(DateTimeHelper.setUtcTimeZone(endDate)),
