...
export const STATUS_COLOR_GROUP = {
  'e-success': ['open', 'Active', 'Completed', 'active', 'completed', 'applied', TIMETHEETS_STATUSES.PENDING_APPROVE, TIMETHEETS_STATUSES.PENDING_APPROVE_ASTERIX, INVOICES_STATUSES.PENDING_APPROVAL],  // green
  ...
  'e-accepted': ['accepted', 'Accepted', 'in progress (accepted)', TIMETHEETS_STATUSES.ORG_APPROVED, TIMETHEETS_STATUSES.APPROVED], // purple
