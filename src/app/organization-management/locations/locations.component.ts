...
export class LocationsComponent extends AbstractPermissionGrid implements OnInit, OnDestroy {
  ...
  editLocation(location: Location, event: Event): void {
    ...
    this.locationDetailsFormGroup.setValue({
      ...
      inactiveDate: location.inactiveDate ? DateTimeHelper.setCurrentUtcDate(location.inactiveDate) : null,
      reactivateDate: location.reactivateDate ? DateTimeHelper.setCurrentUtcDate(location.reactivateDate) : null,
