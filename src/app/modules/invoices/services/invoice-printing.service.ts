...
Hauppauge, NY 11788`,
  ...
  private addPendingRecordInvoiceBody(doc: jsPDF, data: PrintInvoiceData, img: HTMLImageElement): void {
    ...
    autoTable(doc, {
      ...
      tableLineColor: '#181919',
      tableLineWidth: 1,
      head: [['Week End', 'Time in', 'TimeOut', 'Bill Rate Type / Expenses Code Reason', 'Cost Center', 'Job ID', 'Candidate Name',
      'Agency', 'Skill', 'Hours/Miles', 'Bill Rate', 'Total']],
      headStyles: {
        fillColor: '#CFCFCF',
        fontStyle: 'bold',
  ...
  private addAgencyInvoiceBody(doc: jsPDF, data: PrintInvoiceData, img: HTMLImageElement): void {
      ...
      return [
        ...
        },
        {
          ...
          styles: {
           ...
           {
          content: `${GridValuesHelper.formatNumber(record.feeTotal, '1.2-2')}`,
          styles: {
            halign: 'right',
          },
        },
    ...
    autoTable(doc, {
      ...
      tableLineWidth: 1,
      head: [['Week End', 'Time in', 'TimeOut', 'Bill Rate Type', 'Cost Center', 'Job ID', 'Candidate Name',
      'Organization', 'Skill', 'Hours/Miles', 'Bill Rate', 'Fee, %', 'Fee Amount' ,'Total']],
      headStyles: {
        fillColor: '#CFCFCF',
        fontStyle: 'bold',
        fontSize: 10,
