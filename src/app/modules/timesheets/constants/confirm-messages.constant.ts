...
export const SwitchingDnwOffForApprovedTimesheetDialogContent =
  `By switching DNW off for Approved Timesheet its status will be changed to Missing. Would you like to proceed?`;
