export enum TIMESHEETS_ACTIONS {
  ...
  GET_TIMESHEET_REORDERS = '[timesheets] GET TIMESHEET REORDERS',
  GET_ORGANIZATIONS = '[timesheets] GET ORGANIZATIONS',
  GET_AGENCY_ORGANIZATIONS = '[timesheets] GET ORGANIZATIONS FOR AGENCY',
...
export enum TimesheetDetailsActions {
  ...
  GetOrganizationsStructure = '[timesheet details] Get organizations structure',
